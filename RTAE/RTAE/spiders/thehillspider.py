...
class MySpider(CrawlSpider):
    ...
    xpathitem.article_content = '//div[@class="field-item even"]/descendant-or-self::*[not(self::script)]/text()'
    xpathitem.article_timestamp = '//*[@id="content"]/article/p/span[2]/text()'
